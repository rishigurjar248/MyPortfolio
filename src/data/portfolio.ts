...
export const projects = [
  {
    ...
    title: "CoinEquityX",
    description:
      "A finance-focused crypto dashboard and investment tracking project that brings portfolio insights and market data into a streamlined user experience.",
    image: null,
    techStack: [
      "React",
      "Node.js",
    ...
    liveLink: "https://github.com/rishigurjar248/CoinEquityX",
    githubLink: "https://github.com/rishigurjar248/CoinEquityX",
    featured: true,
  ...
  },
  {
    ...
    title: "PulsePoint-",
    description:
      "A real-time analytics project designed to surface live activity, performance metrics, and interactive monitoring for modern applications.",
    image: null,
    techStack: ["React", "Node.js", "PostgreSQL", "Realtime Data", "Charts"],
    category: ["React", "Node.js", "PostgreSQL"],
    liveLink: "https://github.com/rishigurjar248/PulsePoint-",
    githubLink: "https://github.com/rishigurjar248/PulsePoint-",
    featured: true,
  ...
  },
  {
    ...
    description:
      "A payment processing project focused on secure transaction flows, gateway integrations, and robust checkout experiences.",
    image: null,
    techStack: ["React", "Node.js", "PostgreSQL", "Payments", "Security"],
    category: ["React", "Node.js", "PostgreSQL"],
    liveLink: "https://github.com/rishigurjar248/payment-gateway-master",
    githubLink: "https://github.com/rishigurjar248/payment-gateway-master",
    featured: false,
  ...
  },
  {
    ...
    description:
      "A hands-on Redis-inspired project focused on core in-memory data structures, command handling, and storage fundamentals.",
    image: null,
    techStack: [
      "Node.js",
      "Redis",
    ...
    liveLink: "https://github.com/rishigurjar248/Build-Your-Own-Redis",
    githubLink: "https://github.com/rishigurjar248/Build-Your-Own-Redis",
    featured: false,
    color: "from-red-500/20 to-rose-500/20",
  },
  {
    id: 5,
    title: "rishiqrcodegenerator",
    description:
      "A QR code generation utility built to create shareable, lightweight codes for links, text, and quick-access content.",
    image: null,
    techStack: ["React", "TypeScript", "Frontend", "Generator", "Utility"],
    category: ["React", "TypeScript"],
    liveLink: "https://github.com/rishigurjar248/rishiqrcodegenerator",
    githubLink: "https://github.com/rishigurjar248/rishiqrcodegenerator",
    featured: false,
    color: "from-violet-500/20 to-purple-500/20",
  },
  {
    id: 6,
    title: "Real-Time-Collaborative-Code-Editor_34",
    description:
      "A collaborative coding environment built for real-time multi-user editing, live synchronization, and pair-programming workflows.",
    image: null,
    techStack: ["React", "Node.js", "MongoDB", "WebSockets", "Collaboration"],
    category: ["React", "Node.js", "MongoDB"],
    liveLink:
      "https://github.com/rishigurjar248/Real-Time-Collaborative-Code-Editor_34",
    githubLink:
      "https://github.com/rishigurjar248/Real-Time-Collaborative-Code-Editor_34",
    featured: true,
